...
import { ButtonSwitch, IconMoon, IconSun, SocialMedia } from ".";
...
export const Sidebar = ({ topItems, ontoggleSideBar, showSidebar }: Props) => {
  ...
  return (
    <section>
      <div
        className={`${positionStyle} animationShow fixed top-0 z-50 flex h-screen w-[300px] flex-col justify-between bg-white px-8 py-10 shadow-lg dark:bg-[#202124]`}
      >
